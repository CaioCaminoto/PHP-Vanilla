...
//2. Declarar as Constantes (Valores definidos que não mudam)
const TAXA_INSS = 0.08; //8% => 8/100
const DESCONTO_VT = 150.00; //Em constantes usamos MAISCÚLAS para declarar

//3.Declarar as variáveis (Valores que variam)
//Dados do Empregado
...
$valorHoraExtra = ($salarioBase / 220) * 1.6; //220 -> horas médias mensais trabalhadas - 1,6 -> 160%
...
<body>
  <h2>Demonstrativo de Pagamento</h2>
    ...
    <table>
        ...
        <tr>
            <th>Salário Base</th>
            <!-- usar uma função chamada number format () -->
